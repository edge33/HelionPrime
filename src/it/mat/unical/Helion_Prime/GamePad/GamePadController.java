package it.mat.unical.Helion_Prime.GamePad;
...
public class GamePadController
{
	...
	public boolean controllerPluged = false;
	...
	public GamePadController()
	{
		...
		else
		{
			...
			if(controller!=null)
			{
				...
				System.out.println("Gamepad scelto: " + controller.getName() + ", " + controller.getType());
	...
	/* Ritorna il primo bottone premuto */ 
	public int getButtonPressed()
	{
		boolean[] buttons =this.getButtons();
		int i=69;
